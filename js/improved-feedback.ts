/**
 * @fileoverview Improved Feedback System
 *
...
// ============================================================================
// Improved Feedback System Class
// ============================================================================
...
class ImprovedFeedbackSystem {
   ...
   */
  showValidationResult(validationResult: ValidationResult, exercise?: Exercise): void {
...
// Export class
export { ImprovedFeedbackSystem };

// Export singleton instance
export const feedbackSystem = new ImprovedFeedbackSystem();

// Default export for backward compatibility
export default ImprovedFeedbackSystem;

// Make available globally for backward compatibility
declare global {
  interface Window {
    ImprovedFeedbackSystem: typeof ImprovedFeedbackSystem;
  }
}
